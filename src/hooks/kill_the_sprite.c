...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2025/07/19 15:09:33 by alshakhp          #+#    #+#             */
/*   Updated: 2025/07/19 15:09:51 by alshakhp         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	kill_the_sprite(t_data *data)
{
	t_raycast_h	*h;
	...
	perform_dda(data, h);
	if (data->map->tiles[h->map_y][h->map_x] == tile_sprite)
		data->map->tiles[h->map_y][h->map_x] = tile_floor;
	free(h);
}
